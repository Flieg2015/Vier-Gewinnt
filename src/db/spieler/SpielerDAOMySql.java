...
public class SpielerDAOMySql extends SpielerDAOJDBCImpl {
   ...
   static final String DB_URL = "jdbc:mysql://127.0.0.1/VierGewinnt"; //Hier muss die IP der virtuellen Maschine eingetragen werden Benutzer ="administrator" Passwd= "123456"
